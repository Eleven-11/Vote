layui.config({
    ...
    function init() {
        var aa = window.sessionStorage.getItem("aa");
            ...
            for(var i=0;i<bb.questionList.length;i++){
                ...
                for (var j = 0 ; j < bb.questionList[i].optionList.length ; j++) {
                    ...
                    if (bb.questionList[i].optionRule == 78) {
                        rule +=
                            "<div class='male'>" +
                            "   <input id='item" + c + "' type='radio' name='optionRule" + i + "' value='" + bb.questionList[i].option + "' class='radio_'>" +
                        ...
                        rule +=
                            "<div class='male'>" +
                            "   <input id='item" + c + "' type='checkbox' name='optionRule' value='" + bb.questionList[i].option + "' class='checkbox_'>" +
                            "   <label for='item" + c + "'></label>" +
                            "   <span style='margin-left: 10px'>" +
                            "       <input type='text' class='layui-input option' value='" + bb.questionList[i].optionList[j].option + "' style='border:none;' name='option' readonly='true'>" +
                            "   </span>" +
